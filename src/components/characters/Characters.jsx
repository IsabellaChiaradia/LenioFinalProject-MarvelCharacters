...
const Characters = () => {
  ...
  const handleSearch = async (characterData) => {
    if (characterData) {
      setSearchResults([characterData]);
    } else {
      setSearchResults([]);
    }
  };
  ...
  const handleSearchQuery = async () => {
    if (searchQuery.trim() !== '') {
      const characterData = await fetchCharacterByName(searchQuery);
      handleSearch(characterData);
    } else {
      handleSearch(null);
    }
  };
